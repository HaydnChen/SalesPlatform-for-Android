...
public class DetailActivity extends CleanActivity implements ObservableScrollViewCallbacks, Palette.PaletteAsyncListener {
    ...
    public static void launch(CleanActivity activity, View transitionView, String url, String title) {
