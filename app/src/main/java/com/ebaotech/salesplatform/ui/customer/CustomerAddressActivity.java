 ...
 */
@EActivity(R.layout.activity_customer_address)
public class CustomerAddressActivity extends AbstractActivity {
  ...
  public static void launch(Context context) {
    CustomerAddressActivity_.intent(context).start();
  }
}
