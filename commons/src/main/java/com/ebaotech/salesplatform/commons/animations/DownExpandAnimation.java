package com.ebaotech.salesplatform.commons.animations;
 ...
 *
 */
public class DownExpandAnimation extends Animation {
     ...
     */
    public DownExpandAnimation(View view, int duration) {
