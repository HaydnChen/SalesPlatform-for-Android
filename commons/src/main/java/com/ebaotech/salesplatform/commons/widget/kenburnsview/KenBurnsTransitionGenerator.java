package com.ebaotech.salesplatform.commons.widget.kenburnsview;

/**
 * Created by radicsrichard on 15. 04. 22..
 */
...
import com.ebaotech.salesplatform.commons.animations.MaterialInterpolator;

import java.util.Random;

public class KenBurnsTransitionGenerator implements TransitionGenerator {
    ...
    public KenBurnsTransitionGenerator() {
        this(DEFAULT_TRANSITION_DURATION, new MaterialInterpolator());
    }


    public KenBurnsTransitionGenerator(long transitionDuration, Interpolator transitionInterpolator) {
